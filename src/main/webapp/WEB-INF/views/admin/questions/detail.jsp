...
<form class="forms-sample" action="" method="post">
									...
									<!-- form-group -->
									<div class="form-group row">
										<label for="test02" class="col-sm-2 col-form-label">등록 날짜</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="test02" name="registration_date" value="${vo.registration_date}" readonly="readonly">
										</div>
									</div>
									<!-- //form-group -->
									<!-- form-group -->
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<textarea class="form-control" id="test03" rows="5" readonly="readonly" name="content">${vo.content}</textarea>
										</div>
									</div>
									<!-- //form-group -->
									<!-- form-group -->
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<textarea class="form-control" id="test04" name="answer_content" rows="5">${vo.answer_content}</textarea>
										</div>
									</div>
									<!-- //form-group -->
